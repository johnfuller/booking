...
namespace modules\testingmodule\fields;

use modules\testingmodule\TestingModule;
use modules\testingmodule\assetbundles\testingmodulefieldfield\TestingModuleFieldFieldAsset;
 ...
 * @since     1.0.0
 */
class TestingModuleField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('testing-module', 'TestingModuleField');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'testing-module/_components/fields/TestingModuleField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(TestingModuleFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').TestingModuleTestingModuleField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'testing-module/_components/fields/TestingModuleField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
