...
namespace modules\testingmodule\widgets;

use modules\testingmodule\TestingModule;
use modules\testingmodule\assetbundles\testingmodulewidgetwidget\TestingModuleWidgetWidgetAsset;
 ...
 * @since     1.0.0
 */
class TestingModuleWidget extends Widget
{
    ...
    {
        return Craft::t('testing-module', 'TestingModuleWidget');
    }
    ...
    {
        return Craft::getAlias("@modules/testingmodule/assetbundles/testingmodulewidgetwidget/dist/img/TestingModuleWidget-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'testing-module/_components/widgets/TestingModuleWidget_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(TestingModuleWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'testing-module/_components/widgets/TestingModuleWidget_body',
            [
